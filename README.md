...
**GitHub TON:  _[TON](https://github.com/ton-blockchain)_**

**Info: _[BuiltWith](https://builtwith.com/meta/ton.org)_** _(ton.org the cryptocurrency's official website)_

# ❓ A GENERAL UNDERSTANDING OF WHO IS BEHIND THIS AND WHAT IT IS

**Pavel Durov** – One of the co-founders of Telegram, who in 2018 decided to launch his own cryptocurrency, TON (the original name in the white paper was GRAM, and this name was _[reinstated](https://t.me/durov/521)_ in 2026). On 9 April 2026, Durov _[posted](https://t.me/durov/482)_ on his Telegram channel that changes were to be made to **TON**, referring to them as **MTONGA**. Essentially, this is a technical update to the blockchain, in line with what was previously outlined in the 2018 whitepaper (fast transactions with low fees). As part of these changes, on 4 May 2026, **Pavel Durov** _[dissolved](https://t.me/durov/501)_ the **TON Foundation** (see below for an explanation of what this is) and assumed full responsibility for everything happening within TON. **Telegram** has become the main validator for **TON**.
...
``TON product integrations``
``community growth``
``the development of partnerships``

On 21 April, the official **TON channel** _[described](https://t.me/gram/393)_ this event as a record-breaking raise of $1 billion and thanked the major holders (whales) who had contributed to TON **`"without asking for anything in return"`**.

***HOW IT ACTUALLY HAPPENED***

19 wallets from a single linked cluster of early miners (Large Giver) directly transferred **420.32 million TON**.
A further 17 linked wallets transferred **106.9 million TON**.
Of these wallets:

15 transferred at least **99.99%** of their funds;
a further two transferred **98.98%** and **98.89%** of their balances respectively.

In addition, another wallet contributed **4 million TON**, having previously received **29.27 million TON** from one of the same early miners.

This same miner also funded one of the early payment wallets for TON projects. 

**On 12 September 2023**, seven reserve donors and another early miner transferred **374.99 million TON** to one of the TON Foundation’s wallets. From there, **353.32 million TON** were sent to Telegram treasury wallet.

**On 3 November 2023**, following the announced address migration, all 531.22 million TON were   _**[transferred](https://tonviewer.com/transaction/75cfcf8643b0e2444cb7e2b6fdb3c750c10f6f7eef2141ee0b935d18a2a49aef)**_ :
``from a 3-of-5 multisignature wallet --> to a wallet controlled by a single private key.``

It has not been officially disclosed who controlled this new address or why control was simplified to a single key.

**From 28 July 2025**, **283 million TON** were withdrawn from the reserve.


Of these:
at least **218.25 million TON** (77.12%) went to Telegram ***_[proof](https://tonviewer.com/0:8C397C43F9FF0B49659B5D0A302B1A93AF7CCC63E5F5C0C4F25A9DC1F8B47AB3)_***

a further **20.23 million TON** ended up in the TON Foundation’s payment hub ***_[proof](https://tonviewer.com/0:F4F3591DAB83141601BCDECB25226FE59C38549E43FFBC77EF8A23344D2D15DC)_***


Of the **30 million TON** sent to eight validator pools:


**23.84 million TON** were later returned
**6.15 million TON** remained outside the reserve 


In addition, on **2 August**, the reserve withdrew a further **5 million TON**  ***_[proof](https://tonviewer.com/transaction/226bca164d87dab24029a28da5f8d034b2843adc122269da411550dcfea41df1)_***

Of these:
**1.89 million TON** were sent to the OKX address ***_[proof](https://tonviewer.com/0:07B1A983D23838B86D05B420A42813F624F2CB4F4D91694D8EBACF0F5F4B02AD)_***

**3.09 million TON**, according to the author, passed through a chain of transfers and ultimately ended up in Binance’s hot wallet ***_[proof](https://tonviewer.com/transaction/6e3158f58e530dd0b135cce3ff0e1d1374ffeecc7f9979a5526e618cfac1c396)_***

A further **2 million TON** were transferred to a new address and remain there.
Following all these transactions, **248.22 million TON** remained in the reserve.

**On 29 July** — one day after the first ***_[withdrawal](https://tonviewer.com/transaction/e553a9866b4236dfc2af41f3c6b38738f1c375836d85bdc97dbc99a4b3461a08)_*** of **100 million TON** from the reserve — Telegram received two transfers:

27.51 million TON  ***_[proof](https://tonviewer.com/transaction/c430a46d371d16dae576e8f35edccd39d4fa94db72f9e9eea169bf5352733580)_***

27.43 million TON ***_[proof](https://tonviewer.com/transaction/0498af20cd7dbab4fa49a4f358ca6e46f53615222526ce353a33c2da297175e9)_***

**On 31 July**, Telegram signed an agreement with TON Strategy.
**On 8 August**, Telegram transferred **149.01 million TON** to TON Strategy as part of a deal worth **$272.7 million**

Due to the pooling of funds, it is impossible to determine exactly how much of these **149 million** originated from the TON Ecosystem Reserve.
Furthermore, **Telegram** received this entire amount two days before the agreement was signed

**The Open Network Stiftung** did not exist at all at the time the fundraising campaign took place.
It was not registered until **3 May 2023**, more than a year after the reserve was established.



``None of the donors publicly requested a report on the expenditure of funds.``

``the structure of the transfers indicates that this did not involve 37 independent participants, but rather a single interconnected cluster of early miners, which, in his view, is linked to the Telegram ecosystem.``

``of the 283 million TON withdrawn from the reserve, 218.25 million TON (77.12 per cent) went to Telegram entities.``
